...
- **AI**: Claude Sonnet 4.5 via Vercel AI SDK (`ai` + `@ai-sdk/anthropic`)
...
| `src/lib/ai-personalization.ts` | Two-pass AI personalization (Linkup research → Claude generation) |
| `src/lib/ai-scoring.ts` | AI lead scoring engine (Linkup research → Claude 4-axis scoring) |
